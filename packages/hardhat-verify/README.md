...
This plugin helps you verify the source code for your Solidity contracts. At the moment, it supports [Etherscan](https://etherscan.io)-based explorers, [Sourcify](https://sourcify.dev/),  and explorers compatible with its API like [Blockscout](https://www.blockscout.com/).
